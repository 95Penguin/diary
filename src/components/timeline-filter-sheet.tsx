  ...
  return <>
    <BottomSheet visible={!customRangeVisible} onClose={close} backgroundColor={readingTheme.background}>
      ...
      <View style={styles.values}>
        <Text style={[styles.valueHeading, { color: readingTheme.secondary }]}>选择{FILTER_LABELS[filterKind]}</Text>
...
const styles = StyleSheet.create({
  ...
  values: { minWidth: 0, flex: 1, paddingTop: spacing.sm }, valueHeading: { paddingHorizontal: spacing.md, paddingVertical: spacing.xs, fontSize: 10, fontWeight: '600' }, searchBox: { height: 38, flexDirection: 'row', alignItems: 'center', gap: spacing.sm, marginHorizontal: spacing.sm, marginVertical: spacing.xs, paddingHorizontal: spacing.sm, borderRadius: radii.sm }, searchInput: { flex: 1, height: 38, paddingVertical: 0, fontSize: 12 }, valueScroll: { flex: 1 }, valueList: { paddingHorizontal: spacing.sm, paddingBottom: spacing.sm }, value: { minHeight: 44, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: spacing.sm, paddingHorizontal: spacing.sm, borderBottomWidth: StyleSheet.hairlineWidth, borderBottomColor: colors.border }, valueText: { flex: 1, fontSize: 11, lineHeight: 16 }, valueTextActive: { color: colors.primary, fontWeight: '700' }, valueCheck: { color: colors.primary, fontSize: 13, fontWeight: '700' }, empty: { paddingHorizontal: spacing.sm, paddingVertical: spacing.xl, fontSize: 10, lineHeight: 16, textAlign: 'center' },
  customRangeLabel: { minWidth: 0, flex: 1, gap: 2 }, customRangeSummary: { fontSize: 9, lineHeight: 13 }, customRangeClear: { width: 28, height: 28, alignItems: 'center', justifyContent: 'center', borderRadius: 14, backgroundColor: colors.primarySoft }, customRangeClearText: { color: colors.primary, fontSize: 18, lineHeight: 20 }, customRangeArrow: { fontSize: 20, lineHeight: 24 },
  ...
  rangeEndpoints: { flexDirection: 'row', alignItems: 'center', gap: spacing.sm, paddingHorizontal: spacing.xl, paddingTop: spacing.md }, rangeEndpoint: { minWidth: 0, flex: 1, minHeight: 52, justifyContent: 'center', paddingHorizontal: spacing.md, borderWidth: StyleSheet.hairlineWidth, borderColor: 'transparent', borderRadius: radii.md }, rangeEndpointActive: { borderColor: colors.primary }, rangeEndpointLabel: { fontSize: 9, lineHeight: 12 }, rangeEndpointValue: { marginTop: 2, fontSize: 12, lineHeight: 16, fontWeight: '700' }, rangeSeparator: { fontSize: 10 }, rangeHint: { marginTop: spacing.xs, fontSize: 9, lineHeight: 13, textAlign: 'center' },
