...
const styles = StyleSheet.create({
  ...
  tipRow: { minHeight: 30, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: spacing.sm, paddingHorizontal: spacing.md }, tip: { flexShrink: 1, color: colors.textSecondary, fontSize: 9, textAlign: 'center' }, nearbyButton: { minHeight: 26, justifyContent: 'center', paddingHorizontal: spacing.sm, borderRadius: radii.pill }, nearbyButtonText: { color: colors.primary, fontSize: 9, fontWeight: '700' },
  poiArea: { paddingBottom: spacing.xs }, poiLabel: { paddingHorizontal: spacing.md, paddingBottom: 3, fontSize: 9 }, poiList: { gap: spacing.xs, paddingHorizontal: spacing.md }, poiChip: { maxWidth: 150, minHeight: 30, justifyContent: 'center', paddingHorizontal: spacing.sm, borderRadius: radii.pill }, poiName: { fontSize: 10, fontWeight: '600' }, poiDistance: { marginTop: 1, fontSize: 8 },
  ...
  resolvedAddress: { marginHorizontal: spacing.lg, marginTop: -spacing.xs, marginBottom: spacing.sm, fontSize: 9, lineHeight: 15 },
  accuracy: { marginHorizontal: spacing.lg, marginBottom: spacing.sm, fontSize: 9, lineHeight: 15, textAlign: 'center' },
  message: { marginHorizontal: spacing.lg, marginBottom: spacing.md, color: colors.danger, fontSize: 9, lineHeight: 15, textAlign: 'center' },
});
