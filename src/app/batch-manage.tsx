...
function Action({ label, disabled, danger, onPress }: { label: string; disabled: boolean; danger?: boolean; onPress: () => void }) {
  return <CompactPillButton disabled={disabled} onPress={onPress} style={styles.action}><Text style={[styles.actionText, danger && styles.danger]}>{label}</Text></CompactPillButton>;
}
...
const styles = StyleSheet.create({
  ...
  searchWrap: { padding: spacing.md }, search: { minHeight: 44, paddingHorizontal: spacing.lg, borderRadius: radii.pill, fontSize: 12 }, actionBar: { borderBottomWidth: StyleSheet.hairlineWidth }, selectedCount: { paddingHorizontal: spacing.lg, paddingBottom: spacing.xs, fontSize: 10 }, actions: { paddingHorizontal: spacing.md, paddingBottom: spacing.sm, gap: spacing.xs }, action: { paddingHorizontal: spacing.sm, backgroundColor: colors.primarySoft }, actionText: { color: colors.primary, fontSize: 10, fontWeight: '700' }, danger: { color: '#B4564B' },
  loader: { marginTop: 60 }, list: { padding: spacing.md, paddingBottom: spacing.xxxl, gap: spacing.sm }, item: { minHeight: 62, flexDirection: 'row', alignItems: 'center', padding: spacing.md, borderRadius: radii.md }, itemActive: { borderWidth: 1.5, borderColor: colors.primary }, checkbox: { width: 22, height: 22, alignItems: 'center', justifyContent: 'center', marginRight: spacing.md, borderRadius: 11, borderWidth: 1, borderColor: colors.textFaint }, checkboxActive: { borderColor: colors.primary, backgroundColor: colors.primary }, check: { color: '#fff', fontSize: 12, fontWeight: '700' }, itemBody: { flex: 1 }, itemText: { fontFamily: fonts.serif, fontSize: 13, lineHeight: 20 }, meta: { marginTop: 4, fontSize: 9 },
