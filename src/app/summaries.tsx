...
const styles = StyleSheet.create({
  ...
  totalChange: { maxWidth: '100%', marginTop: 4, fontSize: 8, lineHeight: 11, textAlign: 'center' },
  ...
  chartLabel: { flex: 1, fontSize: 7, textAlign: 'center' },
  ...
  heatMonth: { position: 'absolute', width: 28, fontSize: 7 },
  ...
  exportHintText: { marginTop: spacing.xs, fontSize: 9 },
});
