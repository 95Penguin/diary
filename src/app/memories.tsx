  ...
  return <SafeAreaView edges={['top']} style={[styles.safe, { backgroundColor: readingTheme.background }]}>
    ...
    <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
      ...
      {picked ? <View style={[styles.memoryCard, { backgroundColor: readingTheme.surface }]}>
        ...
        <Pressable onPress={() => router.push({ pathname: '/entry/[id]', params: { id: picked.id } })}>
          {picked.images[0] ? <Image source={{ uri: picked.images[0].uri }} style={styles.image} /> : null}
          <Text numberOfLines={6} style={[styles.memoryContent, { color: readingTheme.text, fontFamily: readingFontFamily, fontSize: 16 * fontScale, lineHeight: 25 * fontScale }]}>{picked.content}</Text>
...
const styles = StyleSheet.create({
  ...
  modeRow: { height: 40, flexDirection: 'row', alignItems: 'center', gap: spacing.sm, marginBottom: spacing.md }, modeButton: { height: 34, flexDirection: 'row', alignItems: 'center', gap: spacing.sm, paddingHorizontal: spacing.md, borderRadius: radii.pill, backgroundColor: colors.primarySoft }, modeButtonText: { color: colors.primary, fontSize: 10, lineHeight: 14, fontWeight: '700' }, modeChevron: { width: 6, height: 6, marginTop: -3, borderRightWidth: 1.5, borderBottomWidth: 1.5, borderColor: colors.primary, transform: [{ rotate: '45deg' }] }, candidateCount: { flex: 1, color: colors.textFaint, fontSize: 9, textAlign: 'right' }, shuffleButton: { width: 34, height: 34, alignItems: 'center', justifyContent: 'center', borderRadius: radii.pill, backgroundColor: colors.primary }, shuffleText: { width: 22, height: 22, color: '#FFFFFF', fontSize: 18, lineHeight: 21, textAlign: 'center', includeFontPadding: false }, tagRow: { gap: spacing.sm, paddingBottom: spacing.md }, tagChip: { paddingHorizontal: spacing.md, paddingVertical: 6, borderRadius: radii.pill, backgroundColor: colors.surfaceMuted }, tagChipActive: { backgroundColor: colors.primarySoft }, tagText: { color: colors.textSecondary, fontSize: 10 }, tagTextActive: { color: colors.primary, fontWeight: '700' },
  memoryCard: { padding: spacing.lg, borderRadius: radii.lg, backgroundColor: colors.surfaceMuted }, memoryHeader: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }, memoryDate: { color: colors.primary, fontSize: 10, fontWeight: '700' }, memoryMenu: { color: colors.textSecondary, fontSize: 13, letterSpacing: 1 }, image: { width: '100%', height: 160, marginTop: spacing.md, borderRadius: radii.md, backgroundColor: colors.border }, memoryContent: { marginTop: spacing.md, color: colors.text, fontFamily: fonts.serif, fontSize: 16, lineHeight: 25 }, meta: { marginTop: spacing.sm, color: colors.textSecondary, fontSize: 10 }, empty: { alignItems: 'center', paddingVertical: 42, borderRadius: radii.lg, backgroundColor: colors.surfaceMuted }, emptyTitle: { color: colors.text, fontFamily: fonts.serif, fontSize: 16 }, emptyText: { marginTop: spacing.sm, color: colors.textFaint, fontSize: 10 },
