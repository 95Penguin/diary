...
const styles = StyleSheet.create({
  ...
  content: { padding: spacing.xl, paddingBottom: spacing.xxxl }, sectionTitle: { marginTop: spacing.xl, marginBottom: spacing.sm, fontSize: 11 }, description: { marginBottom: spacing.md, fontSize: 11, lineHeight: 18 }, card: { borderRadius: radii.lg, overflow: 'hidden' }, healthRow: { minHeight: 70, flexDirection: 'row', alignItems: 'center', paddingHorizontal: spacing.lg }, healthText: { flex: 1, paddingRight: spacing.md }, healthLabel: { fontSize: 13, fontWeight: '600' }, healthDetail: { marginTop: 4, fontSize: 10, lineHeight: 15 }, count: { color: '#B46B54', fontSize: 11, fontWeight: '700' }, ok: { color: colors.primary },
