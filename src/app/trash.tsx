...
const styles = StyleSheet.create({
  ...
  scroll: { paddingHorizontal: spacing.xl, paddingTop: spacing.md, paddingBottom: spacing.xxxl }, note: { marginBottom: spacing.sm, fontSize: 10, textAlign: 'center' },
  groupTitle: { marginTop: spacing.xs, marginBottom: spacing.sm, fontFamily: fonts.serif, fontSize: 14, fontWeight: '600' },
